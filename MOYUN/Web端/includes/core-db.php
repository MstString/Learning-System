...
class coredb extends PDO {
    ...
    public $tables = array(
        'ip' => 'core_ip',
        'log' => 'core_log',
        'configs' => 'moyun_configs',
        'posts' => 'moyun_posts',
        'user' => 'moyun_user',
        'ugroup' => 'moyun_user_group');
    ...
    public $fields = array(
        ...
        'posts' => array('id', 'post_title', 'post_content', 'user_group','post_date', 'post_modified', 'user_group','post_ip', 'post_type', 'post_order', 'post_parent', 'post_user', 'post_password', 'post_name', 'post_url', 'post_status', 'post_meta'),
