...
CREATE TABLE IF NOT EXISTS `moyun_configs` (
...
--
-- 转存表中的数据 `moyun_configs`
--

INSERT INTO `moyun_configs` (`id`, `config_name`, `config_value`, `config_default`) VALUES
(1, 'WEB_TITLE', '默云学习助手', '默云学习助手'),
(2, 'USER_TIMEOUT', '3600', '3600'),
...
(7, 'WEB_URL', 'http://www.stringyang.cn', 'http://www.stringyang.cn'),
...
CREATE TABLE IF NOT EXISTS `moyun_posts` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE IF NOT EXISTS `moyun_user` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
INSERT INTO `moyun_user` (`id`, `user_username`, `user_password`, `user_email`, `user_name`, `user_group`, `user_date`, `user_login_date`, `user_ip`, `user_session`, `user_status`, `user_remember`) VALUES
(1, 'test', 'dd94709528bb1c83d08f3088d4043f4742891f4f', 'admin@admin.com', '管理员', 1, '2016-10-31 23:17:18', '2013-03-20 11:15:57', 2, 'cfcd208495d565ef66e7dff9f98764da', 1, 1);

-- --------------------------------------------------------

--
-- 表的结构 `moyun_user_group`
--

CREATE TABLE IF NOT EXISTS `moyun_user_group` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
--
-- 转存表中的数据 `moyun_user_group`
--

INSERT INTO `moyun_user_group` (`id`, `group_name`, `group_power`, `group_status`) VALUES
(1, '管理员组', 'admin', 1),
(2, '教师组', 'teacher', 1),
(3, '普通用户组', 'normal', 1),
(4, '2014级', '2014', 1),
