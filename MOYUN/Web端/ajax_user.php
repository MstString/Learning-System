...
if (isset($_POST['add_username']) == true && isset($_POST['add_password']) == true && isset($_POST['add_name']) == true && isset($_POST['add_email']) == true && isset($_POST['add_group']) == true) {
    if ($moyunuser->add_user($_POST['add_username'], $_POST['add_password'], $_POST['add_email'], $_POST['add_name'], $_POST['add_group'], $ip_arr['id'])) {
        die('2');
    }
}
...
if (isset($_POST['edit_id']) == true && isset($_POST['edit_username']) == true && isset($_POST['edit_password']) == true && isset($_POST['edit_name']) == true && isset($_POST['edit_email']) == true && isset($_POST['edit_group']) == true) {
    if ($moyunuser->edit_user($_POST['edit_id'], $_POST['edit_username'], $_POST['edit_password'], $_POST['edit_email'], $_POST['edit_name'], $_POST['edit_group']) == true) {
        die('2');
    }
}
...
if (isset($_GET['del']) == true) {
    if ($_GET['del'] != $moyunuser->get_session_login()) {
        $user_list_row = $moyunuser->get_user_row();
        if ($user_list_row > 1) {
            if ($moyunuser->del_user($_GET['del']) == true) {
                die('2');
            }
        }
    }
